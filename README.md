...
Customized for [Ammar Shaikh](https://github.com/aqmmarshaikh) (CEO & Founder of TechyBoy).
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/aqmmarshaikh/ammar-shaikh-resume-.git
    cd ammar-shaikh-resume-
    ```
...
```ts
const config = {
  title: "Shaikh Ammar Mohmmad Yashin | CEO & Founder of TechyBoy",
  author: "Ammar Shaikh",
  email: "ammarshaikh6100@gmail.com",
  site: "https://ammarshaikh.vercel.app",
  githubUsername: "aqmmarshaikh",
  githubRepo: "",
  social: {
    linkedin: "https://www.linkedin.com/in/ammar-shaikh-2107b7387",
    github: "https://github.com/aqmmarshaikh",
    instagram: "https://www.instagram.com/ammar2712009",
    facebook: "https://www.facebook.com/share/1KBPjP7WGQ/",
    whatsapp: "https://wa.me/917801986978",
  },
};
```
...
| `public/Ammar_Shaikh_Resume.pdf` | Résumé PDF for the resume page |
| `public/assets/projects-screenshots/` | Project screenshots (`debat-ai/`, `techyboy-store/`, `techyboy-live/`) |
...
- [Debat AI](https://reason-duel.emergent.host/)
- [Techyboystore](https://techyboystore.vercel.app/)
- [TechyBoy.live](https://techyboy.live)
...
4. **Rename** each keycap object to match the skill's `name` field in `src/data/constants.ts` (e.g. `js`, `react`, `firebase`)
